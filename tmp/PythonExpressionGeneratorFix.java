...
public final class PythonExpressionGenerator {
    ...
    private String generateExpression(RosettaExpression expr,
        ...
        switch (expr) {
            ...
            /*Bug:
                return "next((x for x in (" + generateExpression(first.getArgument(), scope) + " or []) if x is not
                None), None)";
            */
            ...
            case RosettaOnlyElement onlyElement -> {
                /*Bug:
                    return "rune_get_only_element([x for x in (" + generateExpression(onlyElement.getArgument(), scope)
                    + " or []) if x is not None])";
                */ 
    ...
    private String generateLastOperation(LastOperation last, PythonExpressionScope scope) {
        /*Bug
        return "next((x for x in reversed(" + generateExpression(last.getArgument(), scope) + " or []) if x is not N
        one), None)";
        */
